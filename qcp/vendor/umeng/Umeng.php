...
class Umeng {
	...
	//广播
	function sendIOSBroadcast($title,$content,$sandbox='false') {
		...
		$brocast->setPredefinedKeyValue("production_mode", 	$sandbox);
	...
	//单播
	function sendIOSUnicast($title,$content,$device_token,$sandbox='false') {
		...
		// Set 'production_mode' to 'true' if your app is under production mode
		$unicast->setPredefinedKeyValue("production_mode", 	$sandbox);
		// Set customized fields
