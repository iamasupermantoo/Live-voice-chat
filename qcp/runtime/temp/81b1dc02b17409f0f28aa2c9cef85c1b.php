<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:66:"/www/wwwroot/qcp/public/../application/admin/view/index/index.html";i:1562338654;s:56:"/www/wwwroot/qcp/application/admin/view/common/meta.html";i:1565258738;s:58:"/www/wwwroot/qcp/application/admin/view/common/header.html";i:1577176734;s:56:"/www/wwwroot/qcp/application/admin/view/common/menu.html";i:1565059592;s:59:"/www/wwwroot/qcp/application/admin/view/common/control.html";i:1562338654;s:58:"/www/wwwroot/qcp/application/admin/view/common/script.html";i:1562338654;}*/ ?>
<!DOCTYPE html>
...
<a href="javascript:;" class="logo">
    <!-- 迷你模式下Logo的大小为50X50 -->
    <span class="logo-mini"><!--<?php echo mb_strtoupper(mb_substr($site['name'],0,4,'utf-8'),'utf-8'); ?>-->啾咪</span>
    <!-- 普通模式下Logo -->
    <span class="logo-lg"><b><!--<?php echo mb_substr($site['name'],0,4,'utf-8'); ?>-->啾咪</b><!--<?php echo mb_substr($site['name'],4,null,'utf-8'); ?>--></span>
</a>
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <!-- 跳转到登陆 -->
                <!--<li>
                    <a href="/admin_123.php" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
                </li>-->
