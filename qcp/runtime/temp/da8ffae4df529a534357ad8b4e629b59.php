<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/qcp/public/../application/common/view/tpl/dispatch_jump.tpl";i:1565060676;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    ...
    <?php endif; ?>
    <p class="clearfix">
        <a href="/admin_123.php" class="btn btn-grey"><?php echo __('Go back'); ?></a>
        <?php if($url): ?>
...
<div class="copyright">
    <p>Powered by <a href="https://www.fastadmin.net/?ref=jump">Mini</a></p>
</div>
<?php if($url): ?>
