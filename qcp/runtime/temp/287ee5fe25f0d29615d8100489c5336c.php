<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"/www/wwwroot/qcp/public/../application/admin/view/index/login.html";i:1569939276;s:56:"/www/wwwroot/qcp/application/admin/view/common/meta.html";i:1565258738;s:58:"/www/wwwroot/qcp/application/admin/view/common/script.html";i:1562338654;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        ...
        <div class="container">
            <div class="login-wrapper">
                <div class="login-screen">
                            ...
                            <form action="" method="post" id="login-form">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-addon" style="padding:0;border:none;cursor:pointer;">
                                        <!-- <img src="http://tp5_test.miniyuyin.cn/index.php/captcha" width="100" height="30" onclick="this.src = 'http://tp5_test.miniyuyin.cn/index.php/captcha"/> -->
                                        <img src="<?php echo rtrim('/admin_123.php', '/'); ?>/index.php?s=/captcha" width="100" height="30" onclick="this.src = '<?php echo rtrim('/admin_123.php', '/'); ?>/index.php?s=/captcha&r=' + Math.random();"/>
                                    </span>
                                </div>
                                <?php endif; ?>
                    ...
                    <p class="copyright"><a href="https://www.fastadmin.net">Powered By MiNi</a></p>
                </div>
            </div>
        </div>
