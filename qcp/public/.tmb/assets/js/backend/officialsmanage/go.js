define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'officialsmanage/go/index' + location.search,
                    add_url: 'officialsmanage/go/add',
                    edit_url: 'officialsmanage/go/edit',
                    del_url: 'officialsmanage/go/del',
                    multi_url: 'officialsmanage/go/multi',
                    table: 'one_page',
                }
            });
