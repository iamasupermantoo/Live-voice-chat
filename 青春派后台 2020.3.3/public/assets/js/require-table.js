define(['jquery', 'bootstrap', 'moment', 'moment/locale/zh-cn', 'bootstrap-table', 'bootstrap-table-lang', 'bootstrap-table-export', 'bootstrap-table-commonsearch', 'bootstrap-table-template'], function ($, undefined, Moment) {
    var siteurlPath = 'http://47.92.85.75/upload/';
    var Table = {
        list: {},
        ...
        api: {
            ...
            formatter: {
                ...
                image: function (value, row, index) {
                    ...
                    if  (imgurl.indexOf('http') >=0 || imgurl.indexOf('upload') >= 0){
                        imgurl = imgurl;
                    }else{
                        imgurl = siteurlPath+imgurl;
                    }
                    //alert(imgurl);
                    var re = new RegExp("amp;","g");
                    imgurl = imgurl.replace(re, "");
                    var classname = typeof this.classname !== 'undefined' ? this.classname : 'img-sm img-center';
                    return '<a href="' + imgurl + '" target="_blank"><img class="' + classname + '" src="' + imgurl + '" /></a>';
                    //return '<a href="javascript:;" ><img  data-tips-image class="' + classname + '" src="' + imgurl + '" /></a>';
                },
                images: function (value, row, index) {
                    ...
                    $.each(arr, function (i, value) {
                        ...
                        value = value ? value : '/assets/img/blank.gif';
                        var imgurl = Fast.api.cdnurl(value);
                       if  (imgurl.indexOf('http') >=0 || imgurl.indexOf('upload') >=0){
                           imgurl = imgurl;
                       }else{
                           imgurl = siteurlPath+imgurl;
                       }
                        html.push('<a href="' + imgurl + '" target="_blank"><img class="' + classname + '" src="' + imgurl + '" /></a>');
                    });
                    return html.join(' ');
                },
                audio: function (value, row, index) {
                    ...
                    value = Fast.api.cdnurl(value);
                    if  (value.indexOf('http') >=0 || value.indexOf('upload') >=0){
                        value = value;
                    }else{
                        value = siteurlPath+value;
                    }
                    return "<audio height='100px' width='100px' controls=''><source src='"+value+"'></audio>";
                },
                video: function (value, row, index) {
                    ...
                    return "<video height='100px' width='100px' controls=''><source src='"+value+"'></video>";
                },
