define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'officialsmanage/onepage/index' + location.search,
                    add_url: 'officialsmanage/onepage/add',
                    edit_url: 'officialsmanage/onepage/edit',
                    del_url: 'officialsmanage/onepage/del',
                    multi_url: 'officialsmanage/onepage/multi',
                    table: 'one_page',
                }
            });
                    ...
                    [
                        ...
                        {field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate,
                            buttons: [{
                                ...
                                url: 'officialsmanage/onepage/detail'
                            }],
