        ...
        api: {
            ...
            formatter: {
                ...
                image: function (value, row, index) {
                    ...
                    var imgurlHead = imgurl.substring(0,8);
                    var imgurlHeads = imgurl.substring(0,9);
                    if (imgurlHead != '/upload/' && imgurlHead != 'http://4' && imgurlHead != '' && imgurlHead != 'http://t' && imgurlHeads != 'https://t'){
                ...
                video:function (value, row, index){
                    ...
                    if (value){
                        if (value.indexOf('http') >= 0 || value.indexOf('upload') >= 0){
                            ...
                            value = 'http://47.92.85.75/upload/'+value;
                        }
                    }
